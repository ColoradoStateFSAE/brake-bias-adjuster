#pragma once
#if !defined(_MCP2515_H_) && defined(PIO_UNIT_TESTING)
#define _MCP2515_H_
...
class MCP2515
{
    ...
    public:
        MCP2515() = default;
        virtual ~MCP2515() = default;
        virtual ERROR reset(void) = 0;
        virtual ERROR setNormalMode() = 0;
        virtual ERROR setBitrate(const CAN_SPEED canSpeed) = 0;
        virtual ERROR sendMessage(const struct can_frame *frame) = 0;
        virtual ERROR readMessage(struct can_frame *frame) = 0;
};
